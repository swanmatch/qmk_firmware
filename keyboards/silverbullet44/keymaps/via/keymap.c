 ...
 */
  ...
  _______, KC_GRV,  C(KC_LEFT), KC_F3,   C(KC_RGHT), _______,                            _______, LCA(KC_LEFT), KC_F8,   LCA(KC_RGHT), KC_BSLS, RGBRST,
 ...
 */
  ...
  _______, KC_CIRC, KC_AMPR, KC_ASTR, KC_EXLM, KC_LCBR,                          KC_RCBR, KC_1,    KC_2,    KC_3,    KC_PEQL, _______,
                             _______, _______, _______, _______,    MO(_ADJUST), KC_0,    KC_0,    KC_PDOT
  ),

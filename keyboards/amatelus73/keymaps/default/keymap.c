...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
      ...
      KC_PDOT, KC_RCTL,            ALT_T(KC_BSPC), SPACE,   RAISE,           LOWER,   ENTER, KC_LGUI,                KC_LEFT, KC_DOWN, KC_RGHT
    ),
    // RAISE
    [_RAISE] = LAYOUT(
      _______, QK_RBT,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    ...
    [_ADJUST] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______, _______,
              _______, _______, _______, MU_TOGG,  CK_UP,  AU_TOGG, _______,            _______, RGB_SPI, RGB_MOD, RGB_VAI, RGB_SAI, RGB_HUI, _______,
          _______,    _______, _______, MU_NEXT, CK_DOWN, _______, _______,   _______,   _______, RGB_SPD, RGB_RMOD,RGB_VAD, RGB_SAD, RGB_HUD, _______, _______,

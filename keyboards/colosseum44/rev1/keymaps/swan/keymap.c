 ...
 */
  [_QWERTY] = LAYOUT(
    ...
    KC_LCTRL,  KC_Z, KC_X, KC_C, KC_V, KC_B,                KC_N,   KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_MINS,
     LALT_T(KC_SPC), KC_BSPC, CALC, LSFT_T(KC_F5),    GUI_T(KC_F12), CUSL, KC_DEL, LCTL_T(KC_ENT)
  ),
 ...
 */
  ...
  _______, KC_CIRC, KC_AMPR, KC_ASTR, KC_EXLM, KC_LCBR,                      KC_RCBR, KC_1,    KC_2,    KC_3,    KC_PEQL, _______,
                             _______, _______, _______, _______,    KC_PDOT, MO(_ADJUST), KC_0,  KC_00
  ),
...
*/
  ...
  XXXXXXX, XXXXXXX, MU_TOG,  CK_UP,   AU_TOG,  XXXXXXX,                      RGB_SPI, RGB_MOD,  RGB_VAI, RGB_SAI, RGB_HUI, RGBRST,
